...
# (valid_q, valid_k, buf_q, buf_k): the packed buffer is LONGER than the valid
# range, mirroring vLLM's fixed-size chunked-context workspace.
_OPUS_OVERSIZED_CASES = [
    (128, 300, 128, 512),  # k/v oversized only (the vLLM chunked-context shape)
    (128, 300, 256, 512),  # q oversized too
    (256, 512, 256, 1024),  # larger valid range
]
_OPUS_OVERSIZED_IDS = [
